...
public class Repayment implements Serializable {
    ...
    public static final int RENEWAL_WITHHOLD = 2; // 续期代扣
    public static final int CARD_WITHHOLD = 3; // 主动代扣
    ...
    private static final long serialVersionUID = -1761273877502811829L;
    private Integer id;

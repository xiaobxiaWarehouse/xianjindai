...
import com.vxianjin.gringotts.util.security.Base64;
...
public class RSA {
    ...
    public static String encrypt(String source, String publicKey)
        ...
        Cipher cipher = Cipher.getInstance(AESUtil.RSA_ALGORITHM);
    ...
    public static String sign(String content, String privateKey) {
        String charset = AESUtil.CHAR_ENCODING;
        try {

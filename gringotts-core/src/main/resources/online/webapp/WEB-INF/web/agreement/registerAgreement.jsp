...
<div class="ui-page ui-page-theme-a ui-page-active" data-role="page"  style="background:#fff;">
  ...
  <div class="wrapper">
    <div class="agreement">
      <h2>用户注册协议</h2>
      <div class="jy-txt">
        <p><!-- 上海利全信息科技有限公司 -->${companyTitle}在此郑重提示您，本文系您与“${appName}<!-- 极速现金侠 -->”（以下简称平台）之间的法律协议，请您认真阅读并理解本协议。您通过平台点击确认本协议的，即表示您同意遵循本协议的所有约定，本协议在您和平台之间具有法律约束力。如发生法律纠纷，您不得以未仔细阅读或理解本协议为由进行抗辩。</p>
      </div>
      <br>
      <%--<input type="button">--%>
      <div class="em-txt">

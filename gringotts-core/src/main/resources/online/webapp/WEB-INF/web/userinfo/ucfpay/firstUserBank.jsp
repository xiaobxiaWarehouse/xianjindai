...
<div class="ui-page ui-page-theme-a ui-page-active" data-role="page">
    ...
    <div class="wrapper">
        ...
        <div class="js-btn2 mt60" onclick="getBindcardRequest();" id="bc-btn">确认绑定</div>
...
<script type="text/javascript">
    ...
    function getBindcardRequest() {
        if(checkBankType() && checkBank() && checkUserPhone()){
            ...
            data.id=$("#cardId").val();
            openAjax('${path}/ucfpayBindCard/credit-card/userBankRequest?deviceId=${deviceId}&mobilePhone=${mobilePhone}', data,RequestCallback);
        }

...
<div class="ui-page ui-page-theme-a ui-page-active" data-role="page">
    ...
    <div class="wrapper">
        <div class="apply" style="margin-top: 0.4rem;">
            <form id="form" name="form" action="${path}/credit-web/mobileCodeValid" method="post" data-ajax="false">
                ...
                <ul class="zl_info tk_new more-info">
                    <li>
                        <a rel="external" href="javascript:;">
                            <input type="text" value="${mobilePhone} " name="phone" data-role="none" readonly="true">
                        </a>
                    </li>
                    <c:if test="${code == 101 || code == 123}">
                    <li class="nobd">
                        <a rel="external" href="javascript:;">
                            <input type="text" name="SUBMIT_AUTHCODE" id="SUBMIT_AUTHCODE" placeholder="请输入图形验证码" value="" data-role="none" style="width: 65%;">
                            <img src="data:image/jpg;base64,${authCode}" style="display: inline-block;width: 100px;">
                        </a>
                    </li>
                    </c:if>
                    <c:if test="${code == 123 || code == 105}">
                    <li class="nobd">
                        <a rel="external" href="javascript:;">
                            <input type="text" name="SUBMIT_SMSCODE" id="SUBMIT_SMSCODE" placeholder="请输入收到的验证码" value="" data-role="none">
                        </a>
                    </li>
                    </c:if>
                </ul>
...
<script type="text/javascript">
    ...
    function submit1() {
        ...
        if(form.stageCode.value == "101"){
            if(form.SUBMIT_AUTHCODE.value != ""){
                run();
            }else{
                showLoader("图形验证码不能为空！");
            }
        }else if(form.stageCode.value == "123"){
            if(form.SUBMIT_AUTHCODE.value == ""){
                showLoader("图形验证码不能为空！");
            }else if(form.SUBMIT_SMSCODE.value == ""){
                showLoader("短信验证码不能为空！");
            }else{
                run();
            }

        }else if(form.stageCode.value == "105"){
            if(form.SUBMIT_SMSCODE.value != ""){
                run();
            }else{
                showLoader("短信验证码不能为空！");
            }

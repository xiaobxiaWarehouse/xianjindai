...
<body style="background:#fff;">
    <div class="ui-page ui-page-theme-a ui-page-active" data-role="page" style="background:#fff;"><!--
        ...
        --><!-- main start -->
       <div class="wrapper">
	    <div class="gy_ban"><img src="${basePath}/images/gy_banner_yq.png"></div>
	    <div class="gy1"><img src="${basePath}/images/gy_b2_yq.png"></div>
	    <div class="gy2"><img src="${basePath}/images/gy_b3_yq.png"></div>
	        <!-- main end -->
